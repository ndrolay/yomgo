    ...
    <div class="card">
        <div class="card-body">
            ...
            <label for="example-text-input" class="col-sm-2 col-form-label">Github</label>
                <div class="col-sm-10">
                    <input name="github" class="form-control" type="text" value="{{ $allfooter->github }}" id="example-text-input">
                </div>
            </div>
            <!-- end row -->

            <div class="row mb-3">
            <label for="example-text-input" class="col-sm-2 col-form-label">Discord</label>
                <div class="col-sm-10">
                    <input name="discord" class="form-control" type="text" value="{{ $allfooter->discord }}" id="example-text-input">
                </div>
            </div>
            <!-- end row -->
